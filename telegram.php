...
<html>
	<head>
		...
		<title> MUN Crisis  - Telegram Request Form </title>
		 ...
		 <div class="container-fluid navbar-inverse">
		    ...
		    <!-- Collect the nav links, forms, and other content for toggling -->
		      <ul class="nav navbar-nav navbar-right navbar-inverse">
		        ...
		        <li><a href="profile.php">Your Profile <span class="badge"> 42</span></a></li>
		        <li class="active"><a href="#">Telegram <span class="sr-only"></span></a></li>
		      </ul>
		</div><!-- /.container-fluid -->
	</nav> 	 		<h3> This is the Telegram Request Page </h3>
